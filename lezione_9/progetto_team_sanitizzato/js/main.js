...
/*   p1.addEventListener("click", manageClick2);
  ...
  padreDeiP.addEventListener("click", manageClick2, true);//true accende la fase di 'capture', che fa scendere il bubbling
  nonnoDeiP.addEventListener("click", manageClick2, true); */

  // 5
/*   p1.addEventListener("click", clickManager); //incapsuliamo la funzione in un oggetto
  padreDeiP.addEventListener("click", clickManager);
  nonnoDeiP.addEventListener("click", clickManager);
  padreDeiP.addEventListener("click", clickManager, true);//true: 
...
function manageClick2(e) {
  ...
  console.log(this);
  console.log(e.type);
  console.log(e.eventPhase);//fase legata al ciclo vita dell'evento
  console.log("--------");
}
...
//incapsuliamo la funzione in un oggetto
let clickManager = {
  handleEvent(e) {
    console.log("--------");
